...
def database_rw(operation, con, cur, date, types, DTE = 'max'):
    ...
    if operation == 'write':
        ...
        # 逐行插入数据
        #insert_query = f"INSERT INTO {write_table_name} VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
